<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View Assigned Students.aspx.cs" Inherits="Advising_System_Web_app.View_Assigned_Students" %>
...
<body>
    <form id="form1" runat="server">
        <div class="heading">
            <asp:Label ID="Main_Heading" runat="server" Text="View All Assigned Students"></asp:Label>
        </div>
        ...
        <div class="button-container">
            <asp:Button ID="Main6" runat="server" Text="Back to Main Menu" OnClick="Main6_Click" />
        </div>


        <div class="form-group">
            <label for="AID: ">Advisor ID:</label>
            <asp:TextBox ID="AID" runat="server" CssClass="input-field" Width="23%"></asp:TextBox>
        </div>

        <div class="form-group">
            <label for="Maj">Major:</label>
            <asp:TextBox ID="Maj" runat="server" CssClass="input-field" Width="26%"></asp:TextBox>
        </div>
