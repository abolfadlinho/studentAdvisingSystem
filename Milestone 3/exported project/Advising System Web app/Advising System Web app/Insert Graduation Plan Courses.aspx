<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insert Graduation Plan Courses.aspx.cs" Inherits="Advising_System_Web_app.Insert_Graduation_Plan_Courses" %>
...
<body>
    <form id="form1" runat="server">
        <div class="heading">
            <asp:Label ID="Main_Heading" runat="server" Text="Insert Graduation Plan Course"></asp:Label>
        </div>
        ...
        <div class="button-container">
            <asp:Button ID="Main3" runat="server" Text="Back to Main Menu" OnClick="Main3_Click" />
        </div>
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="courseName" runat="server" CssClass="input-field" Width="50%"></asp:TextBox>
        </div>
