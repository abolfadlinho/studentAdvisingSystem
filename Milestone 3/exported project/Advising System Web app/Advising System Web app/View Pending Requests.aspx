<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View Pending Requests.aspx.cs" Inherits="Advising_System_Web_app.View_Pending_Requests" %>
...
<body>
    <form id="form1" runat="server">
        <div class="heading">
            <asp:Label ID="Main_Heading" runat="server" Text="View Pending Requests"></asp:Label>
        </div>
        ...
        <div class="button-container">
            <asp:Button ID="Main8" runat="server" Text="Back to Main Menu" OnClick="Main8_Click" />
        </div>
