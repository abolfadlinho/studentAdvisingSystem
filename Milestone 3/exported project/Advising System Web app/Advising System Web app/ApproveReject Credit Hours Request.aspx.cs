...
{
    public partial class ApproveReject_Credit_Hours_Request : System.Web.UI.Page
    {
        ...
        protected void Main9_Click(object sender, EventArgs e)
        {
        ...
        protected void action_button(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    proc.Parameters.Add(new SqlParameter("@current_sem_code", semCode));
