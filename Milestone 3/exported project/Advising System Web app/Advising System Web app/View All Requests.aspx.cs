...
namespace Advising_System_Web_app
{
    public partial class View_All_Requests : System.Web.UI.Page
    {
        ...
        protected void Main7_Click(object sender, EventArgs e)
        {
        ...
        protected void view_button(object sender, EventArgs e) {
            ...
            SqlCommand students = new SqlCommand("SELECT * FROM  FN_Advisors_Requests(@advisor_id)", conn);
            int id = Int16.Parse(AID.Text);
            students.Parameters.Add(new SqlParameter("@advisor_id", id));
            conn.Open();
