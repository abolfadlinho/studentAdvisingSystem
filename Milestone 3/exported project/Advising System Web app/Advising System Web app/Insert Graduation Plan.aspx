<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insert Graduation Plan.aspx.cs" Inherits="Advising_System_Web_app.Insert_Graduation_Plan" %>
...
<body>
    <form id="form1" runat="server">
        <div class="heading">
            <asp:Label ID="Main_Heading" runat="server" Text="Insert Graduation Plan"></asp:Label>
        </div>
        ...
        <div class="button-container">
            <asp:Button ID="Main2" runat="server" Text="Back to Main Menu" OnClick="Main2_Click" />
        </div>
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="GradDate" runat="server" CssClass="input-field" Width="50%"></asp:TextBox>
        </div>

        <div class="form-group">
            <label for="semHours">Semester Credit Hours:</label>
            <asp:TextBox ID="semHours" runat="server" CssClass="input-field" Width="50%"></asp:TextBox>
        </div>

        <div class="form-group">
            <label for="AID: ">Advisor ID:</label>
            <asp:TextBox ID="AID" runat="server" CssClass="input-field" Width="50%"></asp:TextBox>
        </div>
