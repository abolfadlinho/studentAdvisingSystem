<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update Graduation Plan Date.aspx.cs" Inherits="Advising_System_Web_app.Update_Graduation_Plan_Date" %>
...
<body>
    <form id="form1" runat="server">
        <div class="heading">
            <asp:Label ID="Main_Heading" runat="server" Text="Update Expected Graduation Date"></asp:Label>
        </div>
        ...
        <div class="button-container">
            <asp:Button ID="Main4" runat="server" Text="Back to Main Menu" OnClick="Main4_Click" />
        </div>
        ...
        <div class="form-group">
            <label for="expDate">Expected Graduation Date:</label>
            <asp:TextBox ID="expDate" runat="server" CssClass="input-field" Width="50%"></asp:TextBox>
        </div>

        
            <div class="heading-group">

            <asp:Button ID="Update" runat="server" Text="Update" OnClick="update_button"  />
        </div>
    </form>
</body>
</html>