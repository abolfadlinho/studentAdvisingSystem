<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveReject Courses Request.aspx.cs" Inherits="Advising_System_Web_app.ApproveReject_Courses_Request" %>
...
<body>
    <form id="form1" runat="server">
        <div class="heading">
            <asp:Label ID="Main_Heading" runat="server" Text="Approve/Reject Courses Request"></asp:Label>
        </div>
        ...
        <div class="button-container">
            <asp:Button ID="Main10" runat="server" Text="Back to Main Menu" OnClick="Main10_Click" />
        </div>
    </form>
</body>
</html>
